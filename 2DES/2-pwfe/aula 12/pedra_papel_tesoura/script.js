...
// // Selecionar todos os botões de opção
// let botoesOpcao = document.querySelectorAll('.opcao');

// // Atribuir eventos de clique a cada botão de opção
// botoesOpcao.forEach(botao => {
//     botao.addEventListener('click', function() {
//         let valorOpcaoJogador = this.dataset.valor; // Obter o valor da opção do jogador
//         jogar(valorOpcaoJogador); // Chamar a função jogar com o valor da opção do jogador
//     });
// });

// // Função para determinar o vencedor e exibir o resultado
// function jogar(opcaoJogador) {
//     let opcoesPossiveis = ['pedra', 'papel', 'tesoura', 'lagarto', 'spock'];
//     let opcaoCasa = opcoesPossiveis[Math.floor(Math.random() * opcoesPossiveis.length)]; // Selecionar uma opção aleatória para a casa

//     // Lógica para determinar o resultado
//     if (opcaoJogador === opcaoCasa) {
//         resultado.innerHTML = 'EMPATOU';
//     } else if (
//         (opcaoJogador === 'pedra' && (opcaoCasa === 'tesoura' || opcaoCasa === 'lagarto')) ||
//         (opcaoJogador === 'papel' && (opcaoCasa === 'pedra' || opcaoCasa === 'spock')) ||
//         (opcaoJogador === 'tesoura' && (opcaoCasa === 'papel' || opcaoCasa === 'lagarto')) ||
//         (opcaoJogador === 'lagarto' && (opcaoCasa === 'spock' || opcaoCasa === 'papel')) ||
//         (opcaoJogador === 'spock' && (opcaoCasa === 'tesoura' || opcaoCasa === 'pedra'))
//     ) {
//         resultado.innerHTML = 'VOCÊ GANHOU';
//     } else {
//         resultado.innerHTML = 'VOCÊ PERDEU';
...
//     // Exibir as seleções do jogador e da casa
//     test.innerHTML = opcaoJogador;
//     test1.innerHTML = opcaoCasa;
...
//     // Exibir o botão de jogar novamente
//     playAgain.style.display = 'flex';
// }
