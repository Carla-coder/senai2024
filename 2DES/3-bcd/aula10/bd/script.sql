...
-- Criar um procedimento que atualize os valores dos pedidos somando os valores dos itens_pedido:
...
-- Criar um gatilho que atualize os valores dos pedidos após um item ser inserido no pedido:
