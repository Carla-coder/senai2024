...
LOAD DATA INFILE 'C:/Users/des/Downloads/telefone.csv'
INTO TABLE telefone
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'C:/Users/des/Downloads/linha.csv'
INTO TABLE linha
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'C:/Users/des/Downloads/horario.csv'
INTO TABLE horario
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'C:/Users/des/Downloads/dirige.csv'
INTO TABLE dirige
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
-- ./queries.sql
-- Geradas as consultas necessárias, salva como VISÕES
